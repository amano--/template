...
import { expectUsecaseLine } from '@alike-ddd/common'
import { MockUserAccounts } from '@alike-ddd/common/mocks/user'
import { MockProducts } from '../../mocks/products'

describe('(listRecommendProducts) ', () => {
  describe('多言語対応メッセージが取得できることを確認', () => {
    it('SupportLangの言語が指定された場合、対応した文字列が返却される', async () => {
      const res = await listRecommendProducts({ q: 'ListRecommendProducts', input: { keyword: 'hoge' } })
