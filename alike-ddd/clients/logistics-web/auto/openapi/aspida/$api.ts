...
import type { Methods as Methods4 } from './store/inventory'
import type { Methods as Methods5 } from './store/order'
import type { Methods as Methods6 } from './store/order/_orderId@number'
import type { Methods as Methods7 } from './user'
import type { Methods as Methods8 } from './user/_username@string'
import type { Methods as Methods9 } from './user/createWithArray'
